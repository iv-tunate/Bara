      ...
      <main className="flex-1 flex flex-col bg-white">
        {selectedChat ? (
          <>
            ...
            <div className="bg-yellow-50 border-b border-yellow-200 px-4 py-2 flex items-start gap-3">
              ...
              <p className="text-xs text-yellow-800 leading-tight">
                <span className="font-semibold">Circumvention Warning:</span>{" "}
                Bara is not responsible for transactions or disputes that occur
                outside of this platform. For your protection, please keep all
                communication and payments within the app. Read our{" "}
                <a
                  href="/terms"
                  target="_blank"
